---
title: Display All Physical Fonts That Can Be Used As Strings in Java
draft: false
date: "2018-07-24"
categories:
- Dev
...
Use `getLocalGraphicsEnvironment().getAllFonts();` method defined in 
`java.awt.GraphicsEnvironment` class.

### Cf.

- https://docs.oracle.com/javase/jp/8/docs/api/java/awt/GraphicsEnvironment.html
